...
exports.post = {
    ...
    postUpdate: function (_, _a, _b) {
        ...
        var prisma = _b.prisma, userInfo = _b.userInfo;
        return __awaiter(void 0, void 0, void 0, function () {
            var title, content, error, existingPost, payloadToUpdate;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        title = post.title, content = post.content;
                        return [4, (0, canUserMutatePost_1.canUserMutatePost)({ userId: userInfo.userId, postId: postId, prisma: prisma })];
                    case 1:
                        error = _c.sent();
                        if (error)
                            return [2, error];
    ...
    postPublish: function (_, _a, _b) {
        ...
        var prisma = _b.prisma, userInfo = _b.userInfo;
        return __awaiter(void 0, void 0, void 0, function () {
            var error, postToTogglePublish;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4, (0, canUserMutatePost_1.canUserMutatePost)({ userId: userInfo.userId, postId: postId, prisma: prisma })];
                    case 1:
                        error = _c.sent();
                        if (error)
                            return [2, error];
                    ...
                    case 2:
                        postToTogglePublish = _c.sent();
                        return [2, {
                                userErrors: [],
                                post: prisma.post.update({
                                    data: {
                                        published: !(postToTogglePublish === null || postToTogglePublish === void 0 ? void 0 : postToTogglePublish.published)
                                    },
                                    where: {
                                        id: Number(postId)
                                    }
